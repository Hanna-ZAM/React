...
class SearchBar extends React.Component<MyProps, MyState>{
  constructor(props:MyProps) {
    ...
    this.state = { searchValue: window.localStorage.getItem('searchValue')?window.localStorage.getItem('searchValue') as string:'' };
  }
  render(){
    return (
      <div style={{width:"22rem", 
                   ...
                   display:"flex"}}
      >
        <img src="../src/assets/search-svgrepo-com.svg" alt="search-img" ></img>
