...
const CardList: FC<ChildProps> = (): ReactElement => {
  const bases =
    'https://www.flickr.com/services/rest/?method=flickr.galleries.getPhotos&api_key=fd018fb8b522dc83b621f765fd3951a3&gallery_id=66911286-72157649154168622&format=json&nojsoncallback=1';
